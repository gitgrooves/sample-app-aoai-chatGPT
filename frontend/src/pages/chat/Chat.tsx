                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This is a private chatbot provided by Education Technology. Use this to start a conversation about any subject of interest.</h2>
                            </Stack>
                        ) : (
